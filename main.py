...
# --- YENİLENEN UYARI NOTU ---
st.divider()
st.caption("⚠️ **Yasal Uyarı:** Sonuçlar yapay zeka tarafından üretilmiştir ve hatalı olabilir. Lütfen önemli ödevlerinizde sonuçları kontrol ediniz.")
