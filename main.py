...
# --- ÇEREZ YÖNETİCİSİ (KEY GÜNCELLENDİ: v81 Temiz Başlangıç) ---
...
try:
    ...
    # Çerez ismini değiştirdik (v81) ki test edebilesin
...
if st.session_state.son_cevap:
    ...
    # HATA DÜZELTİLDİ: clean_cevap burada tanımlanıyor, butonlardan önce!
